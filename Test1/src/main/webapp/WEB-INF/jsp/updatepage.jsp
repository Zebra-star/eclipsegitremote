			...
			<form action="updateSubmit.do" method="post">
				<table>
					<tr>
						...
						<td><input id="custName" type="text" name="custName" value="${oneList.custName}"></td>
						<td><input id="custId" type="hidden" name="custId" value="${oneList.custId}"></td>
						<td></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input id="custMobile" type="text" name="custMobile" value="${oneList.custMobile}"></td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
							<textarea id="custAddress" name="custAddress" >${oneList.custAddress}</textarea>
						</td>
						<td></td>
					</tr>
					<tr>
